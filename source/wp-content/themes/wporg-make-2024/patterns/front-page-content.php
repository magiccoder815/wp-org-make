...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Teams', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-eb-garamond-font-family has-heading-1-font-size" style="margin-top:var(--wp--preset--spacing--50);font-style:normal;font-weight:400"><?php esc_html_e( 'Not sure which team to contribute to?', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<?php echo wp_kses_post(
	sprintf(
		...
		__( 'Check out our <a href="%s">contributor wizard</a> and find how to get started.', 'wporg' ),
...
<h2 class="wp-block-heading has-white-color has-text-color has-link-color has-eb-garamond-font-family has-heading-1-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e( 'Shape the future of WordPress', 'wporg' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"is-style-short-text"} -->
<p class="is-style-short-text"><?php esc_html_e( 'Become a Five for the Future participant.', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<li class="has-large-font-size"><a href="https://wordpress.org/five-for-the-future/for-organizations/" data-type="page" data-id="9"><?php esc_html_e( 'Contribute as an organization', 'wporg' ); ?></a></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"fontSize":"large"} -->
<li class="has-large-font-size"><a href="https://wordpress.org/five-for-the-future/for-individuals/" data-type="page" data-id="8"><?php esc_html_e( 'Contribute as an individual', 'wporg' ); ?></a></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
